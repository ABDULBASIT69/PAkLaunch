    ...
    return (
        <div className='pt-48'>
            <div className='header-container'>
                <div className='contactus grid grid-cols-2'>
                    <div>
                        <div><img src={headerlogo} /></div>
                        <p className='text16 font-weight300 font-roboto text-white pt-7 w62'>The passage experienced a surge in popularity during the 1960s when Letraset used it on their dry-transfer sheets, and again during the 90s as desktop publishers bundled the text with their software. Today it's seen all around the web; on templates, websites, and stock designs. Use our to get your ownsoftware. Today it's seen all around the web; on templates, websites, and stock designs. Use our to get your ownsoftware. Today it's seen all around the web; on templates, websites, and stock designs. Use our to get your ownsoftware. Today it's seen all around the web; on templates, websites, and stock designs. Use our to get your own</p>
                    ...
                    <div>
                        ...
                        <form className='pt-8'>
                            ...
                            <button type='submit' class="bg-white rounded-xl px-8 py-3 text16 font-roboto font-weight600 mt-10">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
